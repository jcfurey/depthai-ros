...
void WLSFilter::onInit() {
    subscribeCompat(disparityImgSub, this, "stereo/image_raw");
    subscribeCompat(leftImgSub, this, "left/image_raw");
    subscribeCompat(disparityInfoSub, this, "stereo/camera_info");
